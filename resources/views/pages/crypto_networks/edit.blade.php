@extends('layouts.app')
@section('title', 'Edit Crypto Network | DecentraX Admin')
@section('ogtitle', 'Edit Crypto Network | DecentraX Admin')
@section('header')
            ...
            <div class="col-xl-8 col-lg-10">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Edit Crypto Network</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('crypto-networks.update', $id) }}" method="POST">
                            @csrf
                            @method('PUT')
