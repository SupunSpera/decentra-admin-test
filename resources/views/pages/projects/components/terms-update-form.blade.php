<div>
    <form wire:submit.prevent="submit" onsubmit="setProjectTerms()">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea
                                            ...
                                            placeholder="Enter Project Terms"
                                            wire:model="terms"
                                            rows="5"></textarea>
                                            @if ($errors->has('terms'))
        ...
        <script>
            document.addEventListener('livewire:load', function() {
                ...
                document.addEventListener('livewire:update', function() {
                    if (!isFocused) {
                        // let projectTerms = @this.get('terms');
                        $('#inp_terms').summernote('code', projectTerms);
                    }
                });
            });

            function setProjectTerms() {
                let projectTerms = $('#inp_terms').summernote('code');
                @this.set('terms', projectTerms);
            }
        </script>
    @endpush
</div>
